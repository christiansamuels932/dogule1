...
**Station 31 – Connect Hunde ↔ Kurse:** Branch `feature/station31-hunde-kurse`. Status: Umsetzung abgeschlossen, PR ausstehend. Scope: Hunde↔Kurse Navigation/Listen bidirektional, Teilnehmeranzeige mit Besitzer + Ort, Kurs-Formular-Suche/Chips mit Besitzerkontext. Tests: `pnpm lint` ✅, `pnpm vitest run` ✅, `pnpm build` ✅. Nächster Schritt: PR “Station 31 – Connect Hunde ↔ Kurse” gegen `main`.
