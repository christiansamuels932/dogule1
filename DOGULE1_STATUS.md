...
**Station 30 – Connect Kunden ↔ Kurse:** Branch `feature/station30-kunden-kurse`. Status: Umsetzung abgeschlossen, PR wird erstellt. Scope: Kunden↔Kurse Navigation auf Hundebasis (Teilnehmer = Hunde, Besitzer abgeleitet), Kurs-Formulare mit Typeahead (Kunde/Hund-Spalten, Chips, leere Auswahl erlaubt), API-Validierung `hundIds`, Self-Test-Update. Nächster Schritt: PR “Station 30 – Connect Kunden ↔ Kurse” gegen `main`.
