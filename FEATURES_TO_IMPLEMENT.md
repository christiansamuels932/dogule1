...
Purpose: capture short-term ideas/features so they are not lost before formal implementation.
Status: scratchpad; move items into stations or issues when ready.
...
- [ ] Add top-level app header card with `/home/ran/codex/dogule1/Material/FontanasLogo.png` (181x73) on the left and large white "DOGULE" text to the right; both in the same frame/card as the app title.
