...
CREATE TABLE IF NOT EXISTS kunden (
  ...
  anrede VARCHAR(32) NOT NULL DEFAULT '',
  ...
  heimatort VARCHAR(255) NOT NULL DEFAULT '',
  aufmerksam_durch VARCHAR(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS kurse (
  ...
  status VARCHAR(32) NOT NULL DEFAULT '',
  abo_form VARCHAR(128) NOT NULL DEFAULT '',
  alter_hund VARCHAR(128) NOT NULL DEFAULT '',
  aufbauend VARCHAR(64) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS zahlungen (
  ...
  leistung_von VARCHAR(32) NOT NULL DEFAULT '',
  leistung_bis VARCHAR(32) NOT NULL DEFAULT '',
  waehrung VARCHAR(8) NOT NULL DEFAULT 'CHF',
  netto_betrag DECIMAL(10,2) NOT NULL DEFAULT 0,
  mwst_satz DECIMAL(5,2) NOT NULL DEFAULT 0,
  mwst_betrag DECIMAL(10,2) NOT NULL DEFAULT 0,
  mwst_hinweis VARCHAR(255) NOT NULL DEFAULT '',
  steuerbefreiung_hinweis VARCHAR(255) NOT NULL DEFAULT '',
  zahlungsfrist VARCHAR(32) NOT NULL DEFAULT '',
  zahlungsbedingungen TEXT NOT NULL,
  iban VARCHAR(64) NOT NULL DEFAULT '',
  kontakt_email VARCHAR(255) NOT NULL DEFAULT '',
  kontakt_telefon VARCHAR(64) NOT NULL DEFAULT '',
  issuer_name VARCHAR(255) NOT NULL DEFAULT '',
  issuer_adresse TEXT NOT NULL,
  empfaenger_name VARCHAR(255) NOT NULL DEFAULT '',
